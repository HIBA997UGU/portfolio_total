...
pygame.mixer.music.load(os.path.join(os.path.dirname(__file__), 'assets/music.mp3'))
pygame.mixer.music.set_volume(0.6)
pygame.mixer.music.play(-1, 0.0)
jump_fx = pygame.mixer.Sound(os.path.join(os.path.dirname(__file__), 'assets/jump.mp3'))
jump_fx.set_volume(0.5)
death_fx = pygame.mixer.Sound(os.path.join(os.path.dirname(__file__), 'assets/death.mp3'))
...
#bird spritesheet
bird_sheet_img = pygame.image.load(os.path.join(os.path.dirname(__file__), 'assets/bird.png')).convert_alpha()
